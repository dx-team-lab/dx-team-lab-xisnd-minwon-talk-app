        ...
        <table className="w-full border-collapse table-fixed min-w-[650px]">
          <thead>
            <tr className="bg-[#F1F5F9] border-b">
              <th className="p-2 text-center text-xs font-bold border-r text-slate-700 w-[20%]">사전업무</th>
              <th className="p-2 text-center text-xs font-bold border-r text-slate-700 w-[20%]">민원접수</th>
              <th className="p-2 text-center text-xs font-bold border-r text-slate-700 w-[20%]">민원대응</th>
              <th className="p-2 text-center text-xs font-bold border-r text-slate-700 w-[20%]">협상 전략</th>
              <th className="p-2 text-center text-xs font-bold text-slate-700 w-[20%]">보상협의</th>
            </tr>
          </thead>
          <tbody>
